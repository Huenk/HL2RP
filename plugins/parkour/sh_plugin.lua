...
PLUGIN.desc = "Makes it possible to parkour."

-- Console Variables / Start
CreateConVar( "Parkour_MinForceAdd", 10, { FCVAR_REPLICATED, FCVAR_ARCHIVE } ) -- Min Force Add
CreateConVar( "Parkour_ForceMul", 8, { FCVAR_REPLICATED, FCVAR_ARCHIVE } )	   -- Force Mul
CreateConVar( "Parkour_MaxForceAdd", 20, { FCVAR_REPLICATED, FCVAR_ARCHIVE } ) -- Max Force Adds
CreateConVar( "Parkour_SpeedDivider", 5, { FCVAR_REPLICATED, FCVAR_ARCHIVE } ) -- Speed Dividers
CreateConVar( "Parkour_MaxWallCombo", 3, { FCVAR_REPLICATED, FCVAR_ARCHIVE } ) -- Max Wall Combos
-- Console Variables / End

-- I used my old Parkour Skill that I never updated.
-- Link to old version: http://steamcommunity.com/sharedfiles/filedetails/?id=109024605
-- You can edit ConVar's if you want.

-- WARNING: Dont edit stuff below, if you don't known what you are doing.
